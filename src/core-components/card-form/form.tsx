...
export default function Form() {
  return (
    <Card as="aside" className={style.card}>
      ...
      <form action="" className={style.form_base}>
        ...
        <div className={style.base}>
          ...
          <div className={style.base}>
            <DisplayHorarios dia={manha} />
            <DisplayHorarios dia={tarde} />
            <DisplayHorarios dia={noite} />
          </div>
        </div>
        <div className={style.base}>
          <Text variant="title-md" as="span">Cliente</Text>
